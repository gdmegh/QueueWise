...
import { UserCog, Users, CalendarOff, Check, Send, ArrowRightLeft, Loader2, Calendar as CalendarIcon } from 'lucide-react';
...
export default function StaffPage() {
  ...
  const onShiftRequestSubmit = (data: z.infer<typeof shiftRequestFormSchema>) => {
    ...
    const newRequest: ShiftChangeRequest = {
        ...
        requestedStart: fromDateTime,
        requestedEnd: toDateTime,
        reason: data.reason,
        status: 'pending',
    };
                                            ...
                                            <FormField
                                                ...
                                                <FormItem className="flex flex-col">
                                                    ...
                                                    <PopoverContent className="w-auto p-0" align="start">
                                                        ...
                                                        selected={field.value}
                                                        onSelect={field.onChange}
                                                        disabled={(date) => date < new Date() || date < new Date("1900-01-01") || (shiftRequestForm.getValues("fromDate") && date < shiftRequestForm.getValues("fromDate"))}
                                                        initialFocus
                                                        />
                                                    </PopoverContent>
                                                    </Popover>
